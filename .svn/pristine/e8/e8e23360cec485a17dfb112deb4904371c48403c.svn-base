...
(function ($) {
            ...
            if (menu.hasClass('menu-content')) {
                ...
                menu.children('div').each(function () {
                    ...
                    if (!item.hasClass('menu-sep')) {
                        ...
                        // �������һ�д��룬��ʵ�ֽ� menu-item �� hideOnClick �󶨵��˵�����
    ...
    $.fn.menu.methods = {
        ...
        getItem: function (jq, itemEl) {
            ...
            var item = {
                ...
                // ��������һ�д��룬ʹ��ͨ�� getItem �������ص� menu-item �а��� hideOnClick ����
    ...
    /*
        ���ϴ����� easyui-1.4.2 �汾�� jquery.menu.js Դ�룬��������������� easyui-menu �ؼ��ж� menu-item �� hideOnClick ���Ե�֧�֡�
    */
    ...
    */
    ...
    // ������δ���ʵ�ּ�ʹ�ڿ� IFRAME ������£�һ�� WEB-PAGE ��Ҳֻ��ͬʱ��ʾһ�� easyui-menu �ؼ���
    ...
    function createMenu(options) {
        ...
        if (!opts.items.length) {
            opts.items.push({ text: "��ǰ�޲˵���", disabled: true });
        }
    ...
    $.extend($.easyui, {
        ...
        //  ���ָ�������Դ��� easyui-menu ���󣻸÷����������²���
        //      options: JSON �������ͣ��������Լ̳� easyui-menu �ؼ����������Ժ��¼����ο��ٷ� API �ĵ��������ڴ˻������������²���
        //          id      : һ�� String ���󣬱�ʾ�����Ĳ˵������ ID ���ԡ�
        //          name    : һ�� String ���󣬱�ʾ�����Ĳ˵������ name ���ԡ�
        //          hideOnUnhover   : ���ǹٷ� API ��ԭ�����ԣ��˴�������Ĭ��ֵΪ false��
        //          hideDisabledItem: һ�� Boolean ֵ��Ĭ��Ϊ false�������Ա�ʾ���˵���� disabled: true���Ƿ��Զ����ظò˵��
        //          event   :  ��ʾ����ɲ˵��б�Ķ����¼����󣻸ò����ѡ��
        //          items: һ�� Array ���󣬸���������е�ÿһ��Ԫ�ض���һ�� JSON ��ʽ�������ڱ�ʾһ�� menu-item ������ menu-item �������ԣ��ο��ٷ� API����
        //                  ��������ÿ��Ԫ�ص����ԣ��� easyui-menu �� menu-item �ٷ� API ����������⣬���������������ԣ�
        //              hideDisabledItem: �����Ա�ʾ�ڵ�ǰ�Ӳ˵������µ��˵���� disabled: true���Ƿ��Զ����ظò˵��һ�� Boolean ֵ��Ĭ��ȡ��һ���� hideDisabledItem ֵ��
        //              handler: һ���ص������ʾ����˵���ʱ�������¼���
        //                  �ص����� handler �ͻص����� onclick ��ǩ��Ϊ function(e, itemOpts, target)�����У�
        //                      e       : ��ʾ����˵��б��е����˵������Ķ����¼�����
        //                      itemOpts: ��ʾ��ǰ����Ĳ˵���� options ѡ�
        //                      target  : ��ʾ����˵��ؼ��� HTML-DOM ����
        //                      ������ this ָ�򴥷��¼��ĵ����˵��� HTML-DOM ������
        //                  �?���ͬʱ������ onclick �� handler����ֻ���� handler ���� onclick�������벻Ҫ�����ص���������ͬʱʹ�á�
        //              children: ͬ��һ������� items ���ԣ�Ϊһ�� Array ����
        //          slideOut:   һ�� Boolean ����ֵ����ʾ�˵��Ƿ��Ի�����ʽ��ʾ������Ĭ��Ϊ false��
        //          autoDestroy : Boolean ����ֵ����ʾ�˵��Ƿ�������ʱ�Զ���٣�Ĭ��Ϊ true��
        //      options ����Ҳ��ֱ�Ӷ���Ϊ�������ͣ���Ϊ items ��ʽ�� Array ���󣻵� options ֱ�Ӷ���Ϊ items ��ʽ����ʱ����ɵ� easyui-item ���������������ΪϵͳĬ��ֵ��
        //  ����ֵ������һ�� JSON ��ʽ���󣬸÷��صĶ����о����������ԣ�
        //      menu: �����ڴ������ options �������Ĳ˵� DOM Ԫ�ض�������һ�� jQuery ���󣬸ö���δ��ʼ��Ϊ easyui-menu �ؼ�����ֻ�Ǿ��иÿؼ��� DOM �ṹ��
        //      options: ������� options ������Ľ��ý����δ���ڵ������ڳ�ʼ�� menu Ԫ�ء�
        createMenu: function (options) { return createMenu(options); },

        //  ���ָ�������Դ��� easyui-menu ����������ʾ�������÷�������Ĳ���ͱ�����ļ��еĲ������ createMenu ��ͬ��
        //  ע�⣺�������� createMenu ������֮ͬ�����ڣ�
        //      createMenu: ����ݴ���� options �������� easyui-menu DOM �ṹҪ��� jQuery DOM ���󣬵��Ǹö���δ��ʼ��Ϊ easyui-menu �ؼ���
        //      showMenu: �÷����� createMenu �����Ļ��ϣ��Դ��������� jQuery DOM ������������ easyui-menu �ṹ��ʼ��������ʾ������
        //  ����ֵ������һ�� jQuery ���󣬸ö����ʾ��������ʾ���� easyui-menu Ԫ�أ��÷��ص�Ԫ���Ѿ�����ʼ��Ϊ easyui-menu �ؼ���
        showMenu: function (options) { return createAndShowMenu(options); },

        // ��һ����ʾ easyui-menu �в˵���ϵ����飬������ $.easyui.showMenu �����ܹ�֧�ֵĲ˵��������ʽ���÷����������²���
        //      menuItems   : Array �����ʽ�������е�ÿ��Ԫ�ض���һ����ʾ menu-item �˵���� JSON-Object���� JSON-Object ������������Զ��壺
        //          id      : String ����ֵ��Ĭ��Ϊ null ����ʾ�˵���� ID ��
        //          text    : String ����ֵ��Ĭ��Ϊ null ����ʾ�˵���ı�����Ϣ��
        //          iconCls : String ����ֵ��Ĭ��Ϊ null ����ʾ�˵����ͼ����ʽ��ƣ�
        //          href    : String ����ֵ��Ĭ��Ϊ null ����ʾ�˵���ָ���Զ�̵�ַ��
        //          disabled: Boolean ����ֵ��Ĭ��Ϊ false����ʾ�˵����Ƿ���ã�
        //          bold    : Boolean ����ֵ��Ĭ��Ϊ false����ʾ�ò˵����Ƿ�����Ӵ֣�
        //          style   : JSON-Object ����ֵ��Ĭ��Ϊ null����ʾҪ���ӵ��ò˵������ʽ��
        //          hideOnClick     : Boolean ����ֵ��Ĭ��Ϊ true����ʾ����ò˵��������˵��Ƿ���Զ����أ�
        //          hideDisabledItem: Boolean ����ֵ��Ĭ��Ϊ false�������Ա�ʾ���˵���� disabled: true���Ƿ��Զ����ظò˵��
        //          handler : �ص������ʾ����˵���ʱ�������¼���ǩ��Ϊ function(e, itemOpts, target)��
        //          onclick : �ص������ʾ����˵���ʱ�������¼���ǩ��Ϊ function(e, itemOpts, target)��
        //      args        : ��Ҫ���ӵ������ص�����Ĳ������飻�ò�����������ڣ�
        //          menu-item �е��������Կ�Ϊ�����ֵ��Ҳ����Ϊһ������ֵ�Ļص�������������ֵΪ�ص����������£�����ǩ��Ϊ function (e, itemOpts, target)
        //          ��������������� args ��ֵΪ [a, b, c]�����ڵ��� $.easyui.parseMenuItems ����������menu-item ���ԵĻص�����ǩ����Ϊ function (e, itemOpts, target, a, b, c)��
        //          Ҳ����˵������ args Ҳ��һ������ֵ��Ϊ menu-item ���Իص�����ĵ��ò���ӣ������滻����Ϊԭ���Ĳ���ᱣ����������ĵ����У�
        // ����ֵ������һ�� Array ���飻�������������Ϊ $.easyui.showMenu �������õĲ���
        ...
        // �?����չ���� easyui-menu �ؼ��� menu-item �������Զ�����չ����:
        //      hideOnClick:    Boolean ����ֵ��Ĭ��Ϊ true����ʾ����ò˵��������˵��Ƿ���Զ����أ�
        //      bold:           Boolean ����ֵ��Ĭ��Ϊ false����ʾ�ò˵����Ƿ�����Ӵ֣�
        //      style:          JSON-Object ����ֵ��Ĭ��Ϊ null����ʾҪ���ӵ��ò˵������ʽ��
        // ע�⣺�Զ�����չ���� bold��style ����ͨ�� $.easyui.createMenu ���� $.easyui.showMenu ��ɲ˵�ʱ������Ч��
