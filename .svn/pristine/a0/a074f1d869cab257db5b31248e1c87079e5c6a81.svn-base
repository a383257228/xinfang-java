 ...
 */
@Entity
@Table(name = "ISSUE_TYPE_INFO_TEMP")
public class IssueTypeInfoTemp extends IdEntity{
	private static final long serialVersionUID = 1L;
	private PetitionBasicInfoTemp petitionBasicInfoTemp;	//反映问题信息	
	...
	private String firstFlag = "0"; //主问题类别标示
	private String  parentIssueCode;	//问题类别编码	
	
	/**
	 * @return the petitionBasicInfoTemp
	 */
	...
	/**
	 * @param petitionBasicInfoTemp the petitionBasicInfoTemp to set
	 */
