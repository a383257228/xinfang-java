...
public class SqlHelperFactory {
	...
	static Logger logger = Logger.getLogger(SqlHelperFactory.class); //LogDemo为相关的类
	 ...
	 * 2015-1-23下午03:20:22
	 */
	public SqlHelper createSqlHelper(String queryItemStr){
	 ...
	 * 2015-1-23下午03:20:22
	 */
	public SqlHelper createSqlHelper(String queryItemStr,int type){
