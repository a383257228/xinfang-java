 ...
 */
@Entity
@Table(name="QUI_LETTER_INFO_TEMP")
public class QuiLetterInfoTemp extends AudiEntity{
...
//	private String creatorId;			//创建人标识					CHAR(20)
//	private String creatorName;			//创建人名称					VARCHARA(50)
