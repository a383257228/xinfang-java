...
<html>
  ...
  <body>
  	<div class="sinosoft-layout" idFlag="permissionWin" style="width:100%;height:100%">
		<div par="region:'west'"  style="width:15%;">
	    	...
	    	<ul idFlag="permissionMenu" class="sinosoft-tree"></ul>
	    </div>  
	    <div par="region:'center',border:false" style="width:85%;height:100%">
	    	<table idFlag="permissionMenuGrid"></table>
	    </div>  
  	</div>
  </body>
</html>