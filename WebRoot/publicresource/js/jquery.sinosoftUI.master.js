 ...
 * jQuery EasyUI 1.4.5
 * 
 * Copyright (c) 2009-2016 www.jsinosoft.com. All rights reserved.
 *
 * Licensed under the freeware license: http://www.jsinosoft.com/license_freeware.php
 * To use it on other terms please contact us: info@jsinosoft.com
 *
 */
(function($){
$.sinosoft={indexOfArray:function(a,o,id){
...
},plugins:["systemCodeCombobox","groupGridSinosft","expandGridSinosoft","treegridSinosoft","edatagridSinosoft","datagridSinosoft","redioBox","checkedBox","draggable","droppable","resizable","pagination","tooltip","linkbutton","menu","menubutton","splitbutton","switchbutton","progressbar","tree","textbox","filebox","combo","combobox","combotree","combogrid","numberbox","validatebox","searchbox","spinner","numberspinner","timespinner","datetimespinner","calendar","datebox","datetimebox","slider","layout","panel","datagrid","propertygrid","treegrid","datalist","tabs","accordion","window","dialog","form"],parse:function(_c){
var aa=[];
for(var i=0;i<$.parser.plugins.length;i++){
var _d=$.parser.plugins[i];
var r=$(".sinosoft-"+_d,_c);
if(r.length){
if(r[_d]){
r.each(function(){
...
if(r1||r2){
$(this).addClass("sinosoft-fluid");
}else{
$(this).removeClass("sinosoft-fluid");
}
});
}
...
if($(this).hasClass("sinosoft-fluid")||_a8){
_8e(this);
}
return false;
});
...
if(_f6.id==undefined){
_f6.id="sinosoft_tree_node_id_temp";
_12c(_f0,_f6);
}
...
if(_f7&&_f7.id=="sinosoft_tree_node_id_temp"){
_f7.id="";
_12c(_f0,_f7);
}
...
_115(_116,_117,flag);
if(opts.deepCheck){
$.sinosoft.forEach(_117.children||[],true,function(n){
_115(_116,n,flag);
});
}else{
var _119=[];
...
var c1=0;
var len=0;
$.sinosoft.forEach(row.children||[],false,function(r){
if(r.checkState){
len++;
...
$.sinosoft.forEach(data,true,function(node){
_174.push(_171(node));
});
return _174;
};
...
var _17a=[];
$.sinosoft.forEach($.data(_178,"tree").data,true,function(n){
if(n.checkState&&$.sinosoft.indexOfArray(_179,n.checkState)!=-1){
_17a.push(_171(n));
}
});
return _17a;
...
$.sinosoft.forEach(data.children,true,function(node){
_171(node);
});
}
return data;
...
var ids={};
$.sinosoft.forEach(_19b.data,true,function(node){
...
item.domId="_sinosoft_tree_"+_1bf++;
cc.push("<li>");
...
if(item.checked){
$.sinosoft.addArrayItem(_1c2.tmpIds,item.domId);
}
}
...
if($(this).hasClass("sinosoft-fluid")||_1e0){
_1e1(_1df);
}
return false;
});
...
if($(this).hasClass("sinosoft-fluid")||_21f){
_20f(_21d);
}
return false;
});
...
if(_258.length){
_258.layout("resize");
$("body").children(".sinosoft-fluid:visible").each(function(){
...
var s=$(_263).find("div.panel:visible,div.accordion:visible,div.tabs-container:visible,div.layout:visible,.sinosoft-fluid:visible").filter(function(_265,el){
...
if($(".window-mask").length>1){
	$($(".window-mask")).each(function(index){
		if(index>10){
			$(this).remove();
		}
	})
...
bb.insertAfter(_29c);
tb.add(bb)._outerWidth(t._outerWidth()).find(".sinosoft-fluid:visible").each(function(){
$(this).triggerHandler("_resize");
});
...
if($(this).hasClass("sinosoft-fluid")||_2dd){
_2bc(_2db);
}
return false;
});
...
p_t.find(".sinosoft-fluid:visible").triggerHandler("_resize");
};
};
function _32f(_330){
...
if($(this).hasClass("sinosoft-fluid")||_338){
_323(_336);
_32f(_336);
}
return false;
...
if($(this).hasClass("sinosoft-fluid")||_3ab){
_39d(_3a7);
}
return false;
});
...
if($(this).hasClass("sinosoft-fluid")||_3f9){
...
if($(this).hasClass("sinosoft-fluid")||_45a){
_45b(_458);
}
return false;
});
...
$.fn.validatebox.defaults={required:false,validType:null,validParams:null,delay:200,interval:200,missingMessage:"此项为必填项",invalidMessage:null,tipPosition:"right",deltaX:0,novalidate:false,editable:true,disabled:false,readonly:false,validateOnCreate:true,validateOnBlur:false,events:{focus:_48d,blur:_491,mouseenter:_494,mouseleave:_497,click:function(e){
var t=$(e.data.target);
...
var lableName=$(_4c5).attr("lableName")
if(lableName){
	tb.find("input.textbox-text").attr("name",lableName);
	$(_4c5).removeAttr("lableName");
}
...
if($(this).hasClass("sinosoft-fluid")||_4e2){
_4cc(_4db);
}
return false;
});
...
var _52a="sinosoft_frame_"+(new Date().getTime());
...
//
if(form[0].enctype="application/x-www-form-urlencoded"){
...
for(var name in data){
	...
	if(form.find("input[name=\""+name+"\"]").attr("type")=="radio"){
		$(form.find("input[name=\""+name+"\"]")).each(function(){
			if($(this).attr("value")==$.trim(val)){
				$(this).parents(".sinosoft-redioBox").eq(0).redioBox("setCheck");
			}
		})
	};
	if(form.find("input[name=\""+name+"\"]").attr("type")=="checkbox"){
		$(form.find("input[name=\""+name+"\"]")).each(function(){
			var arr=val.split(",")
			var checked=this;
			$(arr).each(function(){
				if($(checked).attr("value")==$.trim(this)){
					$(checked).parents(".sinosoft-checkedBox").eq(0).checkedBox("setCheck");
				}
			})
...
if(f){
	return $.fn.form.methods[_554](this,_555,f);	
}else{
...
$.fn.form.defaults={fieldTypes:["systemCodeCombobox","combobox","combotree","combogrid","datetimebox","datebox","combo","datetimespinner","timespinner","numberspinner","spinner","slider","searchbox","numberbox","textbox","switchbutton"],novalidate:false,ajax:true,iframe:true,url:null,queryParams:{},onSubmit:function(_558){
...
if($(this).hasClass("sinosoft-fluid")||_574){
_56f(_573);
}
return false;
});
...
var _5e1=0;
function _5e2(a,o){
return $.sinosoft.indexOfArray(a,o);
};
function _5e3(a,o,id){
$.sinosoft.removeArrayItem(a,o,id);
};
function _5e4(a,o,r){
$.sinosoft.addArrayItem(a,o,r);
};
...
var ss=["<style type=\"text/css\" sinosoft=\"true\">"];
...
ss.push("</style>");
$(ss.join("\n")).appendTo(cc);
cc.children("style[sinosoft]:not(:last)").remove();
},getRule:function(_5ee){
var _5ef=cc.children("style[sinosoft]:last")[0];
...
function _652(_6d6,_6d7){
	...
	var cellColor=$(_6d6).attr("cellColor")
	if(cellColor){
		var row=opts.finder.getRow(_6d6,_6d7); 
		opts.onMouseOverCell.call(_6d6,event,_6d7,row);  
	}else{
...
var _76e=$.extend({},_760(["systemCodeCombobox","text","textbox","numberbox","numberspinner","combobox","combotree","combogrid","datebox","datetimebox","timespinner","datetimespinner"]),{textarea:{init:function(_76f,_770){
...
ck.addClass("tree-checkbox"+flag);
if(flag==0){
$.sinosoft.removeArrayItem(_8b3,opts.idField,row[opts.idField]);
}else{
$.sinosoft.addArrayItem(_8b3,opts.idField,row);
}
};
function _8ae(_8b4,row,_8b5){
var flag=_8b5?1:0;
_8b0(_8b4,row,flag);
$.sinosoft.forEach(row.children||[],true,function(r){
_8b0(_8b4,r,flag);
});
};
...
var _8e6=null;
$.sinosoft.forEach(_8e5.data,true,function(node){
...
$.sinosoft.removeArrayItem(_90e.checkedRows,opts.idField,_90d);
_89f(_90c);
if(prow){
...
_925=_925||"checked";
var rows=[];
$.sinosoft.forEach(jq.data("treegrid").checkedRows,false,function(row){
...
var flag=0;
var crow=$.sinosoft.getArrayItem(_941.checkedRows,opts.idField,row[opts.idField]);
if(crow){
flag=crow.checkState=="checked"?1:2;
}else{
var prow=$.sinosoft.getArrayItem(_941.checkedRows,opts.idField,row._parentId);
if(prow&&prow.checkState=="checked"&&opts.cascadeCheck){
flag=1;
row.checked=true;
$.sinosoft.addArrayItem(_941.checkedRows,opts.idField,row);
}else{
if(row.checked){
$.sinosoft.addArrayItem(_941.tmpIds,row[opts.idField]);
}
}
...
return $.sinosoft.indexOfArray(_9dd.data,_9dd.options.valueField,_9dc);
};
...
$.sinosoft.forEach(_9f9.data,false,function(row){
if(row["selected"]){
$.sinosoft.addArrayItem(vv,row[opts.valueField]+"");
}
});
if(opts.multiple){
_9eb(_9f7,vv,_9f8);
...
_a22++;
_a26.itemIdPrefix="_sinosoft_combobox_i"+_a22;
_a26.groupIdPrefix="_sinosoft_combobox_g"+_a22;
_a26.groups=[];
var dd=[];
var _a27=undefined;
for(var i=0;i<data.length;i++){
...
var _a32=$.sinosoft.indexOfArray(_a31.groups,"value",_a30);
...
$.sinosoft.addArrayItem(_a40,node.id);
});
}
...
var item=$.sinosoft.getArrayItem(a,"id",_a50);
...
$.sinosoft.addArrayItem(opts.mappingRows,"id",_a5e);
return _a5e.id;
}else{
return _a5e;
}
...
var item=$.sinosoft.getArrayItem(a,opts.idField,_a84);
...
$.sinosoft.addArrayItem(opts.mappingRows,opts.idField,_a92);
...
if($(this).hasClass("sinosoft-fluid")||_ae8){
_ae9(_ae6);
}
return false;
});
